...
void gnerateDatas() {
	reverseData1000 = (int **)malloc(7 * sizeof(int *));
	reverseData10000 = (int **)malloc(7 * sizeof(int *));
	reverseData100000 = (int **)malloc(7 * sizeof(int *));
	randomData1000 = (int **)malloc(7 * sizeof(int *));
	randomData10000 = (int **)malloc(7 * sizeof(int *));
	randomData100000 = (int **)malloc(7 * sizeof(int *));
	for (int i = 0; i < 7; i++) {
